...
while True:
    ...
    # Calculate the FPS
    fps = 1 / time_taken
    # If the FPS is higher than the maximum FPS, sleep for a while to limit the FPS
    if fps > fps_limit:
        time.sleep(1 / fps_limit - time_taken)
        
    # Add the FPS as text on top of the frame
    fps_text = "FPS: {:.2f}".format(fps)
    cv2.putText(frame, fps_text, (10, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
